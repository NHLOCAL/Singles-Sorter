...
data = [
    ...
    ("תום ביטון מגיש ביצוע ווקאלי ללחן של קרליבך שומר ישראל", {'entities': [(0, 9, 'SINGER'), (36, 42, 'SINGER')]}),
    ...
    ("04 מחרוזת מחווה קרליבך - איתי גלינסקי , יובל שפיגלמן שאול פנחסוב רובי הרי", {'entities': [(25, 37, 'SINGER'), (40, 52, 'SINGER'), (53, 64, 'SINGER'), (65, 73, 'SINGER')]}),
