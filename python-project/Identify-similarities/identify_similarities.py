...
# וממירה אותם לאמת או שקר בהתאם לרמת הדמיון בין המחרוזות
# ובהתאמה לאורך המחרוזות
def true_or_false(text, text_list):
    """
...
if __name__ == '__main__':
    text = "אברימי רוט"
    text_list = ["אברימי לוי", "אברהם פריד", "מוטי שטיינמץ"]
