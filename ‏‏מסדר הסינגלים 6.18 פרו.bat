...
set/p pa=">>>"
if not exist %pa% echo !בוש הסנ יוגש ביתנה & timeout 2 & goto 2.0
cls
...
echo                                                 6.0+ מסדר הסינגלים>>%help%
echo ==============================================>>%help%
echo מטרת התוכנה היא לסדר את הסינגלים שלכם בצורה מסודרת לפי אמנים>>%help%
echo אופן השימוש פשוט: יש לגרור את תיקיית הסינגלים הרצוייה לתוך חלון התוכנה וללחוץ על אנטר>>%help%
echo אחר כך יש לגרור תיקיה חדשה או כל תיקיה שהיא שאתם רוצים שהסינגלים המסודרים יעברו אליה, וללחוץ שוב על אנטר >>%help%
echo התוכנה מעבירה או מעתיקה את הקבצים (לבחירתכם) לתיקיה החדשה ונותנת בסוף התהליך סיכום של מספר השירים שהועברו>>%help%
echo התוכנה כוללת כרגע כמות של כמה מאות זמרים, ומנסיוני, היא תעביר לרוב כמות של כ-50%% מהסינגלים שברשותכם>>%help%
echo אם יש שיר עם דואט, היא פשוט תעביר את השם הראשון שרשום לה, בדרך כלל זה יעביר את הזמר הראשון בסדר אלפבתי>>%help%
echo .לדוגמא: "מרדכי בן דוד ואברהם פריד" -התוכנה תעביר את השיר לאברהם פריד>>%help%
echo באגים נוספים: לעיתים התוכנה עשויה שלא לזהות זמר מסוים, לדוגמא: זמר בשם "אברהם פרידמן" היא תכניס ל"אברהם פריד">>%help%
echo הערה חשובה! התוכנה סורקת גם תיקיות משנה^<^<^<>>%help%
echo.>>%help%
echo ניתן להעתיק ולהפיץ בשמחה...>>%help%
echo  nh.local11@gmail.com :קרדיט>>%help%
...
echo    6.0+ םילגניסה רדסמ
echo =======================
echo ישארה טירפתל רוזחל תנמ לע תע לכב 0 ץחל
echo.
